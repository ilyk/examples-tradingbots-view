...
import {defaultSimulationBot, Status} from "../../../_services";
                        ...
                        <Form
                            ...
                            <div className={"row"}>
                                ...
                                {!values.bot.config.is_arbitrage || <React.Fragment>
                                    ...
                                    <SliderInterval label={"OrderBook Update Interval"} max={values.bot.config.interval}
                            ...
                            <div className={"row"}>
                                ...
                                <CheckBox label={"Simulation"}
                                          name={"bot.config.simulation"}/>
                                ...
                                <NumericField name={"bot.config.min_trades"} label={"Min Trades"} step={1}
                                              min={values.bot.config.is_arbitrage ? 1 : 8}/>
                                <NumericField name={"bot.config.max_trades"} label={"Max Trades"} step={1}
                                              min={values.bot.config.is_arbitrage ? 1 : 8}/>

                                <NumericField name={"bot.config.volume_coefficient"} label={"Volume Coefficient"}/>
                                <NumericField name={"bot.config.price_coefficient"} label={"Price Coefficient"} step={0.00000001} />
